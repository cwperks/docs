...
public class GetDocumentTransportAction extends HandledTransportAction<GetDocumentRequest, GetDocumentResponse> {
    ...
    @Override
    protected void doExecute(Task task, GetDocumentRequest request, ActionListener<GetDocumentResponse> listener) {
