...
public class ListCommentsRequest extends ActionRequest {
  private final String documentId;

  public ListCommentsRequest(String documentId) {
    this.documentId = documentId;
  }

  public ListCommentsRequest(StreamInput in) throws IOException {
    super(in);
