...
public class UpsertDocumentRequest extends ActionRequest {
    ...
    public UpsertDocumentRequest(String documentId, String title, String content, Long seqNo, Long primaryTerm) {
