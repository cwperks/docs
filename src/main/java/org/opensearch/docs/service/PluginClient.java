...
public class PluginClient extends FilterClient {
    ...
    protected <Request extends ActionRequest, Response extends ActionResponse> void doExecute(
        ...
        try (ThreadContext.StoredContext context = threadPool().getThreadContext().newStoredContext(false)) {
            subject.runAs(() -> super.doExecute(action, request, ActionListener.runBefore(listener, context::restore)));
