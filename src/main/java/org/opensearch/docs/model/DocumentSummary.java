...
public class DocumentSummary implements Writeable, ToXContentObject {
    ...
    public DocumentSummary(String id, String title, String excerpt, String lastUpdatedBy, long updatedAt, long seqNo, long primaryTerm) {
        this.id = id;
        this.title = title;
    ...
    public DocumentSummary(StreamInput in) throws IOException {
        this(in.readString(), in.readString(), in.readString(), in.readString(), in.readLong(), in.readLong(), in.readLong());
    }
